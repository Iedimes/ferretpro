...
foreach ($products as $p) {
    ...
    $imgHtml = !empty($p['image']) ? '<img src="' . BASE_URL . '/' . htmlspecialchars($p['image']) . '" style="max-height: 80px; object-fit: contain;" class="mb-2">' : '<div class="mb-2" style="height: 80px; display: flex; align-items: center; justify-content: center; background: #f8f9fa; border-radius: 5px;"><i class="bi bi-image text-muted" style="font-size: 2rem;"></i></div>';
